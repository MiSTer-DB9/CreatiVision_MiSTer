...
UPSTREAM_REPO="https://github.com/MiSTer-devel/CreatiVision_MiSTer.git"
CORE_NAME=(CreatiVision)
...
UPSTREAM_CORE_NAME=(CreatiVision)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(CreatiVision.qpf)
COMPILATION_OUTPUT=(output_files/CreatiVision.rbf)
